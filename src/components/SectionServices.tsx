...
import SoluctionsIcon from '@/../public/assets/icon-solutions.svg';
import OptionsIcon from '@/../public/assets/icon-options.svg';
import CardIcon from '@/../public/assets/icon-card.svg';
import ImagePhone from '@/../public/assets/phone.png';    
        ...
        <section className="relative w-full h-[965px]">
            <Container>
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <p className="text-lg max-w-[554px] mb-16 text-second-gray">Veja como você pode cuidar das suas finanças
                        pelo app Itaú de forma segura, rápida e o melhor,
                    ...
                    <ul>
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            <div className="w-7 h-7 flex items-center justify-center">
                                <Image src={SoluctionsIcon} alt="Ícone de telefone" />
                            </div>
                    ...
                    <ul>
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            <div className="w-7 h-7 flex items-center justify-center">
                                <Image src={OptionsIcon} alt="Ícone de telefone" />
                            </div>
                    ...
                    <ul>
                        <li className="flex items-center gap-9 ">
                            <div className="w-7 h-7 flex items-center justify-center">
                                <Image src={CardIcon} alt="Ícone de telefone" />
                            </div>
